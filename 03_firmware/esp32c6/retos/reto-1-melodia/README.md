...
3. **Compila y sube** al ESP32:
   ```powershell
   arduino-cli compile --fqbn esp32:esp32:esp32c6 seccion-4-retos/reto-1-melodia
   arduino-cli upload -p COM3 --fqbn esp32:esp32:esp32c6 seccion-4-retos/reto-1-melodia
   ```
4. **Toca el sensor** → escucha tu melodía.
5. Cuando suene como quieres, **aplica los mismos cambios** a `tetrisTheme()` en `03_firmware/mochi_unified_5/mochi_unified_5.ino`.
