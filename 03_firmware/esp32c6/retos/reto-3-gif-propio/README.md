...
1. Abre el sketch `mochi_unified_5.ino` en Arduino IDE
...
|---------|-------|---------|
| No aparece en el Modo 1 | El `.bin` no está en `data/` | Verifica que el archivo quedó en `03_firmware/mochi_unified_5/data/` |
