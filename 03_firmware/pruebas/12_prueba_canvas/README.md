...
> Sketch de prueba del **modo Canvas** para el robot Mochi (ESP32-C6 Supermini).  
...
- **Microcontrolador:** ESP32-C6 Supermini (compatible con cualquier ESP32)
...
```bash
arduino-cli compile --fqbn esp32:esp32:esp32c6 --build-property "compiler.cpp.extra_flags=-DDEBUG_LOCAL" .
```
...
|---------|---------------|----------|
| OLED en blanco al arrancar | Pines SDA/SCL incorrectos o dirección I2C distinta | Verifica GPIO 6 (SDA) y GPIO 7 (SCL); prueba con un scanner I2C |
