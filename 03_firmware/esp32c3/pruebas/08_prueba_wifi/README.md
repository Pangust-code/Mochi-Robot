...
Verifica que el ESP32-C3 Super Mini puede conectarse a una red WiFi, obtener una IP y sincronizar la hora con NTP. Reproduce el comportamiento exacto del Modo 2 (Reloj) del firmware principal.
