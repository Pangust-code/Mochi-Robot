...
| Componente | Pin | GPIO ESP32-C3 Super Mini | Función |
|-----------|-----|--------------------------|---------|
| Buzzer pasivo | SIG | GPIO 10 | Salida PWM |
| Buzzer pasivo | GND | GND | Tierra |
| OLED SH1106 | SDA | GPIO 8 | I2C datos |
| OLED SH1106 | SCL | GPIO 9 | I2C reloj |
...
| Sin sonido en ningún test | Pin desconectado o buzzer roto | Verifica GPIO 10 y el cable GND |
