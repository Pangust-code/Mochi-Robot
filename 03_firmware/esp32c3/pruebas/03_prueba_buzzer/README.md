# 🔈 Suite de Pruebas de Hardware: ESP32-C3 Super Mini + Buzzer Pasivo + OLED + TTP223
...
| :--- | :--- | :--- | :--- | :--- |
| **Buzzer** | SIG / PWM | **GPIO 10** | Salida PWM | Generación de frecuencias (sonido) [cite: 86]. |
| **Buzzer** | GND | GND | Tierra | Referencia común de potencial. |
| **OLED SH1106** | SDA | **GPIO 8** | Bus Datos I2C | Transmisión de datos de pantalla [cite: 86]. |
| **OLED SH1106** | SCL | **GPIO 9** | Bus Reloj I2C | Sincronización de pantalla [cite: 86]. |
...
Una vez superados los tests, el ESP32-C3 Super Mini entra en un bucle que vincula directamente las interacciones táctiles del TTP223 con respuestas sonoras, utilizando los mismos umbrales de tiempo del firmware final (`HOLD_MS = 800`, `MULTITAP_MS = 400`) [cite: 86]:
...
3. Compila y sube el archivo `.ino` a tu ESP32-C3 Super Mini.
